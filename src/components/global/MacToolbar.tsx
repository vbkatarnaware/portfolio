...
export default function MacToolbar() {
  ...
  return (
    <div className={`hidden md:block transition-opacity duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] ${phase >= 2 ? 'opacity-100' : 'opacity-0'}`}>
      <div className='sticky top-0 z-50 flex bg-white/40 backdrop-blur-[12px] border-b border-black/[0.05] text-[#1d1d1f] h-8 px-6 items-center justify-between text-sm font-medium'>

...
export default function MobileDock({ onOpenQRapid }: MobileDockProps) {
  ...
  return (
    ...
    >
      <div className='mb-[75px] py-3 px-5 bg-[#1c1c1e]/60 border border-white/10 backdrop-blur-2xl rounded-[30px] flex justify-between items-center w-[92%] max-w-[340px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] pointer-events-auto'>

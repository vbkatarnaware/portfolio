...
import { Mail, AppWindow, MapPin } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl text-[14px] font-sans pb-12">
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <a 
          href="mailto:vipulkatarnaware@gmail.com"
          ...
          aria-label="Send Email to vipulkatarnaware@gmail.com"
        >
          ...
          <div className="flex-1">
            <div className="text-white font-medium text-[15px]">vipulkatarnaware@gmail.com</div>
          </div>
        </a>
